...
import { Menu, Box, Button,Divider } from "@mantine/core";
  ...
  return (
    <Box sx={{ position: "relative", textAlign: "center" }}>
      ...
      >
        ...
        <Menu.Label> Want to contribute ?  </Menu.Label>
        <Menu.Item component='a' href='https://github.com/khandakar227/alquran'>
